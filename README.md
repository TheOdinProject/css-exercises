...
1. Fork and copy this repository. Copies of repositories on your machine are called clones. Forking is an easy process, and can be learned [here](https://docs.github.com/en/get-started/quickstart/fork-a-repo). If you need help cloning to your local environment you can learn how [here](https://docs.github.com/en/github/creating-cloning-and-archiving-repositories/cloning-a-repository-from-github/cloning-a-repository).
